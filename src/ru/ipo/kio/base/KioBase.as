package ru.ipo.kio.base{
	...
	public class KioBase
	{
		...
		private static var _instance:KioBase = new KioBase;

        private var _currentProblem:KioProblem;
		
        private var workspace:DisplayObject;
		private var stage:DisplayObjectContainer;
		private var problems:Array /*KioProblem*/ = new Array;
		
		public function init(stage : DisplayObjectContainer, problems:Array):void {
			this.stage = stage;
			this.problems = problems;
			
			KioApi.registerLocalization(KioBase.BASE_API_ID, BaseLocalization_RU());
			
            KioApi.initialize(new BaseProblem());

			var contestPanel:ContestPanel = new ContestPanel();
